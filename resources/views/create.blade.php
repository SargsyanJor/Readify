...
<div class="mx-auto max-w-2xl">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div class="mb-8 border-b border-slate-100 pb-5">
            <h2 class="text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">Add New Book</h2>
            <p class="mt-1 text-sm text-slate-500">Fill out the information below to register a new book in the library.</p>
        </div>
